...
var ShapeFramework = {
   ...
   * 绘制
   */
  drawShape: function /* cfg, group */ drawShape() {},
  /**
   * 绘制完成后的操作，便于用户继承现有的节点、边
   */
  afterDraw: function /* cfg, group */ afterDraw() {},
  // update(cfg, item) // 默认不定义
  afterUpdate: function /* cfg, item */ afterUpdate() {},
  /**
   * 设置节点、边状态
   */
  setState: function /* name, value, item */ setState() {},
  /**
   * 获取控制点
   * @param  {Object} cfg 节点、边的配置项
   * @return {Array|null} 控制点的数组,如果为 null，则没有控制点
